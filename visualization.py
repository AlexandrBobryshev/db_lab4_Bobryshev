...
with conn:
    ...
    bar_ax.set_title('Загальна сума продажів кожного товару.')
    bar_ax.set_xticklabels(items, rotation=45, ha='right', fontsize = 7)  
    ...
    mark_color = 'blue'
    graph_ax.plot(average_item_price, total_order_price, color=mark_color, marker='o')
